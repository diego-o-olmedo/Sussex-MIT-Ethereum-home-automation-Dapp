...
!function () {
    ...
    tinycolor.prototype = {
        isDark: function () {
            ...
            var hsv = rgbToHsv(this._r, this._g, this._b), h = mathRound(360 * hsv.h), s = mathRound(100 * hsv.s),
            ...
            var hsl = rgbToHsl(this._r, this._g, this._b), h = mathRound(360 * hsl.h), s = mathRound(100 * hsl.s),
            ...
            var hex8String = "#" + rgbaToHex(this._r, this._g, this._b, this._a), secondHex8String = hex8String,
        ...
        var w1, rgb1 = tinycolor(color1).toRgb(), rgb2 = tinycolor(color2).toRgb(), p = amount / 100, w = 2 * p - 1,
            a = rgb2.a - rgb1.a;
    ...
    var names = tinycolor.names = {
        ...
        var CSS_INTEGER = "[-\\+]?\\d+%?", CSS_NUMBER = "[-\\+]?\\d*\\.\\d+%?",
...
// RGB color Modal
var colorPickerTemplates = colorPickerTemplates || {};
colorPickerTemplates['modal-template-rgb.html'] =
    ' <ion-modal-view class="color-picker-modal" ng-class="::ui.modalClass">\n' +
